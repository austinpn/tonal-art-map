...
// namespace Scripts{
// public class TonalArtMapGeneratorTransparent {
...
// 		// manually
// 		public TonalArtMapGeneratorTransparent(
// 				int potSize,
// 				Texture strokeTex,
// 				Color sourceColor,
// 				int toneLevels,
// 				int mipLevels,
// 				AnimationCurve strokeCurve,
// 				float minTone,
// 				float maxTone,
// 				float height,
...
// 			tones = new float[toneLevels, mipLevels];
// 			tones1 = new float[toneLevels, mipLevels];
...
// 						if (strokeList.Count > 5000) {
// 							Debug.Assert(false);
// 							return;
// 						}
// 						// Debug.Assert(strokeList.Count < 1000);
...
// 		void ApplyStroke(Stroke stroke, int strokeNum, int toneLevel, int mipLevel, bool horizontal) {
